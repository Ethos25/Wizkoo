/* Combined data + chrome for the side-by-side compare page.
   Avoids const redeclaration that would happen if r3-data.jsx and
   r4-data.jsx both loaded at once. Exports every global both
   Diagrammatic and Ledger reach for. */
/* global React */
...
// ----- R3-style brand band: thin planetarium header above day strip -----
// (used by Diagrammatic — matches r3-data.jsx's BrandBand + DayStrip exactly)
...
// ----- R4-style planetarium band (locked spec) — used by Ledger -----
...
Object.assign(window, {
  ...
  useExpand, PhoneStatus,
  BrandBand, DayStrip,
  PlanetariumBand, ModeLabel, BlockKids,
});
