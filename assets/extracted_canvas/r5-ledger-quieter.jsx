...
// =============================================================
// Direction A — LEDGER QUIETER
// Same structural logic as Ledger; every element pushed to its
// lightest defensible weight WITHOUT removing any content.
//   – row vertical padding: 16 → 22 (more air per row)
//   – cluster name: 16/500 → 17/500 (slightly larger, more breathing)
//   – subject dot: 6px → 5px
//   – position number: 10 → 9 mono, in a faint warm-gray (#B7B4A8)
//   – chevron: bold ▸▾ → 8px hairline arrow in faint warm-gray
//   – row rule: solid var(--rule) → solid #ECE7DA (chalk-on-rule)
//   – inline divider: 10px ink-tinted → 9px chalk-tinted (#DCD6C5)
//   – mono kicker letterspacing: 0.14em → 0.18em (more air in the type)
// =============================================================

function LedgerQuieter({ openId, setOpen }) {
  return (
...
function QRow({ c, index, isOpen, onToggle, isLast }) {
          ...
          <div>
            ...
            <div style={{ marginTop: 6, display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontFamily: "Plus Jakarta Sans", fontWeight: 400, fontSize: 12, color: "var(--mid)" }}>
                {c.blocks.length} × 20-min · {QmodeWord(c.mode)}
              </span>
            </div>
          </div>
...
Object.assign(window, { LedgerQuieter });
