...
(function () {
  ...
  if (!document.getElementById('wn-styles')) {
    ...
    style.textContent = [
      ...
      '  transition:width 0.25s var(--expo);',
      '}',
      ...
      '  white-space:nowrap;',
      '  flex-shrink:0;',
      '  transition:border-color 0.22s var(--expo),box-shadow 0.22s var(--expo);',
      '}',
      '.nav-cta:hover{',
      ...
      '.nav-mobile-menu.open .nav-mobile-menu-inner{transform:translateY(0);transition:transform 300ms var(--expo)}',
      '.nav-mobile-menu a{',
      '  display:block;',
      '  font-family:\'Space Mono\',monospace;',
      '  font-weight:400;',
  ...
  if (!prerendered) el.innerHTML = [
    ...
    '    <a href="https://app.wizkoo.com/start"          class="nav-link">The Plan</a>',
    ...
    '    <a href="https://app.wizkoo.com/start" class="nav-cta">Build Our Week</a>',
    '  </div>',
    '</div>',
