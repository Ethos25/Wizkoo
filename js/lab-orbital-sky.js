/**
 * THE LAB SKY: the certified field re-derived for the orbital aperture.
 *
 * WHAT THIS IS
...
(function () {
  ...
  if (typeof window !== 'undefined') {
    ...
    var mount = function () {
      var host = document.querySelector('[data-lab-sky]');
      if (!host || host.dataset.labSkyMounted || !window.WizkooSky) return;
      host.dataset.labSkyMounted = '1';
      var r = renderLabSky(window.WizkooSky, host, Number(host.dataset.labSkySeed) || SEED);
      host.dataset.labSkyStars = String(r.stars);
    };
